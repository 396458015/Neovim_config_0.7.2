...
command! Pull execute "FloatermNew!git pull<CR>git reset --hard<CR>"
...
t['<C-b>'] = {'scroll', {'-vim.api.nvim_win_get_height(0)', 'true', '110'}}
t['<C-f>'] = {'scroll', { 'vim.api.nvim_win_get_height(0)', 'true', '110'}}
